...
//     //                               A   C   T   C
//                                     {0b0000011110110111U, 0}};
//     std::vector< km::sortedlist::Virtual_skmer<kuint> > expected_virtual_skmers {km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[0],4,1,0),km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[1],3,2,0),km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[2],2,3,0),km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[3],1,4,0) };
...
//     std::vector< km::sortedlist::Virtual_skmer<kuint> > expected_virtual_skmers {km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[0],4,1,0), km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[1],3,2,0),km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[2],2,3,0)};
...
//     // km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[0],4,2,0),
//     std::vector< km::sortedlist::Virtual_skmer<kuint> > expected_virtual_skmers { km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[0],3,3,0),km::sortedlist::Virtual_skmer<kuint>(expected_kpairs[1],3,4,0)};
...
//     std::forward_list<km::sortedlist::Virtual_skmer<kuint>> computed_list;
...
//     const std::vector<km::sortedlist::Virtual_skmer<kuint>> expected_list {km::sortedlist::Virtual_skmer<kuint>(expected_skmers[0], prefix_suffix[0].first, prefix_suffix[0].second , column[0]),km::sortedlist::Virtual_skmer<kuint>(expected_skmers[1], prefix_suffix[1].first, prefix_suffix[1].second , column[1])};
...
//         km::sortedlist::Virtual_skmer<kuint> expected_vskmer {*vector_iterator};
//         km::sortedlist::Virtual_skmer<kuint> computed_vskmer {*list_iterator};
...
//     std::forward_list<km::sortedlist::Virtual_skmer<kuint>> computed_list {km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[0],4,1),0),0), km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[1],4,1),0),1)};
//     // km::Skmer<kuint> sk1 {manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[0],0))};

//     // computed_list. km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[0],0)), 4, 1), 0), km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[1],0), 4, 1), 1)};
...
//     std::forward_list<km::sortedlist::Virtual_skmer<kuint>> computed_list {km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[0],3,2),1),0), km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[1],3,2),1),1)};
...
//     const std::vector<km::sortedlist::Virtual_skmer<kuint>> expected_list {km::sortedlist::Virtual_skmer<kuint>(expected_skmers[0], prefix_suffix[0].first, prefix_suffix[0].second , column[0]), km::sortedlist::Virtual_skmer<kuint>(expected_skmers[1], prefix_suffix[1].first, prefix_suffix[1].second , column[1]), km::sortedlist::Virtual_skmer<kuint>(expected_skmers[2], prefix_suffix[2].first, prefix_suffix[2].second , column[0])};
...
//     std::forward_list<km::sortedlist::Virtual_skmer<kuint>> computed_list {km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[0],2,3),2),0), km::sortedlist::Virtual_skmer<kuint>(manip.get_skmer_of_kmer(km::Skmer<kuint>(input_skmers[1],2,3),2),1)};
...
//     const std::vector<km::sortedlist::Virtual_skmer<kuint>> expected_list {km::sortedlist::Virtual_skmer<kuint>(expected_skmers[0], prefix_suffix[0].first, prefix_suffix[0].second , 0), km::sortedlist::Virtual_skmer<kuint>(expected_skmers[1], prefix_suffix[1].first, prefix_suffix[1].second , 1), km::sortedlist::Virtual_skmer<kuint>(expected_skmers[2], prefix_suffix[2].first, prefix_suffix[2].second , 2)};
...
//     const std::vector<km::sortedlist::Virtual_skmer<kuint>> expected_list {km::sortedlist::Virtual_skmer<kuint>(expected_skmers[0], prefix_suffix[0].first, prefix_suffix[0].second , 0), km::sortedlist::Virtual_skmer<kuint>(expected_skmers[1], prefix_suffix[1].first, prefix_suffix[1].second , 2), km::sortedlist::Virtual_skmer<kuint>(expected_skmers[2], prefix_suffix[2].first, prefix_suffix[2].second , 1), km::sortedlist::Virtual_skmer<kuint>(expected_skmers[3], prefix_suffix[3].first, prefix_suffix[3].second , 1)};
